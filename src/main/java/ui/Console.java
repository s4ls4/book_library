...
public class Console {
    ...
    public Console( XMLBookService XMLBookService, XMLClientService XMLClientService) {
    ...
    private Book readBook() throws Exception {
        System.out.println("Read book {id, serialNumber, name, number of authors, price}");
        BufferedReader bufferRead = new BufferedReader(new InputStreamReader(System.in));
        ...
        int nrAuthors = Integer.parseInt(bufferRead.readLine());
        System.out.println("authors {name, ssn}");
        ArrayList<Author> authors = new ArrayList<>();
        while(nrAuthors != 0) {
            String aName = bufferRead.readLine();
            int ssn = Integer.parseInt(bufferRead.readLine());
            Author a = new Author(aName, ssn);
            authors.add(a);
            nrAuthors--;
        }
        ...
        Book book = new Book(serialNumber, name, authors, price);
        book.setId(id);
        return book;
    }
